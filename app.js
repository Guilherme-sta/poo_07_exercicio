...
class App {
    ...
    inserirConta() {
        ...
        let conta;
        if (tipo == '2') {
            conta = new banco_1.Poupanca(numero, saldo, 10);
        }
        else if (tipo == '3') {
            conta = new banco_1.ContaImposto(numero, saldo, 10);
        }
        else {
    ...
    realizarOrdemBancaria() {
        ...
        let numeros = this.input('Digite os números das contas separados por espaço: ').split(" ");
    ...
    transferirTitularidade() {
        ...
        let numeroConta = this.input('Digite o número da conta: ');
        let cpfCliente = this.input('Digite o CPF do novo titular: ');
