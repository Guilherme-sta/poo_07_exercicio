...
class App {
    ...
    menu() {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case "08": this.realizarOrdemBancaria(); break;
                case "09": this.transferirTitularidade(); break;
                case "10": this.listarContasSemClientes(); break;
                case "11": this.renderJuros(); break;
                case "20": this.inserirCliente(); break;
                case "21": this.consultarCliente(); break;
                case "22": this.associarContaCliente(); break;
                case "23": this.totalizarSaldoCliente(); break;
    ...
    private inserirConta(): void {
        ...
        let tipo: string = this.input('Digite o tipo da conta: 1 - Conta   2 - Poupança  3 - Conta Imposto: ');
        let conta: Conta;

        if (tipo == '2') {
            conta = new Poupanca(numero, saldo, 10);
        } else if (tipo == '3') {
            conta = new ContaImposto(numero, saldo,10);
        } else {
    ...
    private realizarOrdemBancaria() {
        ...
        let numeros: string[] = this.input('Digite os números das contas separados por espaço: ').split(" ");
    ...
    private transferirTitularidade() {
        console.log("\nTransferir titularidade de conta");
        let numeroConta: string = this.input('Digite o número da conta: ');
        let cpfCliente: string = this.input('Digite o CPF do novo titular: ');
